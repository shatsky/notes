...
- зашифрованные данные должны выглядеть как "случайный шум" (чтобы взломщик не мог расшифровать посредством статистического анализа)
...
Распространенные симметричные криптосистемы: AES, ChaCha
